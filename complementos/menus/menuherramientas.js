...
module.exports = {
	nome: "menuherramientas",
	desc: "Menú de herramientas",
...
╭━━⪩ COMANDOS ⪨━━
▢ • ${prefix}Attp [texto]
▢ • ${prefix}Fazernick [texto]
▢ • ${prefix}Ssweb [url]
▢ • ${prefix}Unbinary [codigo]
▢ • ${prefix}Tiktoknotif [usuario]
▢ • ${prefix}Creator
▢ • ${prefix}Info
▢ • ${prefix}Ping
▢ • ${prefix}Uptime
...
`;
			const jid = msg.from;
			// Usar la foto específica del menú de herramientas
			let fotomenu = global.fotos.fotomenuherramientas;
			if (!fotomenu) {
			...
			console.error(error);
			msg.reply('Error al mostrar el menú de herramientas.');
		}
	}
};