...
`;
			const jid = msg.from;
			// Usar la foto específica del menú de descargas
			let fotomenu = global.fotos.fotomenudescargas;
			if (!fotomenu) {
			...
			console.error(error);
			msg.reply('Error al mostrar el menú de descargas.');
		}
	}
};