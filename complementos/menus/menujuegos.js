...
`;
			const jid = msg.from;
			// Usar la foto específica del menú de juegos
			let fotomenu = global.fotos.fotomenujuegos;
			if (!fotomenu) {
			...
			console.error(error);
			msg.reply('Error al mostrar el menú de juegos.');
		}
	}
};